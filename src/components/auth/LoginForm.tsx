...
export const formSchema = z.object({
  email: z
    .string()
    .endsWith("@gmail.com", { message: "Digite um email válido!" }),
    ...
    try {
      ...
      if (!userCredential.user.emailVerified) {
        toast({
          ...
          description:
            "Enviamos um link ao seu email para confirmar que é realmente você.",
          variant: "destructive",
        });
        await auth.signOut();
        return;
      ...
      toast({
        ...
        description:
          "Bem-vindo(a) de volta! Redirecionando para a loja em 3 segundos...",
      });
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(handleLoginUser)} className="space-y-8">
        ...
        />
        <Button type="submit" className="w-full rounded-sm py-6">
          Entrar
        </Button>
      </form>
    </Form>
